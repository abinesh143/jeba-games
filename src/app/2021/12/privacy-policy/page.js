const PrivacyPolicy = () => {
  return <main>
    <div className="mt-10 md:mt-20 sm:pb-8">
        ...
        <div className="rounded-b-[24px] bg-[#FCE594] rounded-tr-[24px] sm:rounded-b-[32px] sm:rounded-tr-[32px]">
          <div className="flex text-xs  sm:text-base 2xl:text-xl h-fit text-ellipsis overflow-hidden ...">
            <div className=" px-4 sm:px-8 lg:px-6 xl:px-8 pt-4 sm:pt-8 lg:pt-6 xl:pt-8 lg:pb-20 max-lg:text-justify relative">
              <p>
                SJS Software built the Moving Stickers app as a Free app. This
                SERVICE is provided by SJS Software at no cost and is intended
                for use as is.
              </p>
              ...
              <p>
                ...
                in our Terms and Conditions, which is accessible at Moving
              ...
              <p>
                ...
                <a href="mailto:jebaselvin12@gmail.com">
                  jebaselvin12@gmail.com
                </a>
                .
              </p>
      ...
      <div className="sm:px-8 lg:px-10 py-4">{/* <Footer /> */}</div>
    </div>
  </main>;
};
