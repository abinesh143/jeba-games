...
import { blog as currentNews } from "../../../json/blog.json";
  ...
  return (
    <div className=" bg-top bg-no-repeat sm:pb-10 lg:pb-20 mt-10 lg:mt-20">
      {article?.slug ? (
        ...
        <div className="text-center min-h-[calc(100vh-550px)]">Page Not Found</div>
      )}
    </div>
  );
};

export default ChildTrendingBlog;
