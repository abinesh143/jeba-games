    ...
    <footer className="bg-gray-900">
      <div className="w-full">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4 mx-auto max-w-screen-xl">
          ...
          <div>
            ...
            <ul className="text-white  font-medium">
              ...
              <li className="mb-4">
                <a href="/games" target="_blank" className="hover:underline">
                  Games
                </a>
              </li>
              <li className="mb-4">
                <a href="/tools" target="_blank" className="hover:underline">
                  Tools
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="text-white  font-medium">
              <li className="mb-4">
                <a
                  href="https://www.freeappmaker.pro/"
                  target="_blank"
                  className="hover:underline"
                >
                  Free App Maker
              ...
              <li className="mb-4">
                <a
                  href="https://www.freeappmaker.pro/dares"
                  target="_blank"
                  className="hover:underline"
                >
                  Dare Message
        ...
        <div className="px-4 py-6 bg-gray-100  md:flex md:items-center md:justify-between">
          <span className="text-sm text-gary-900  sm:text-center">
            © 2024 <a href="https://freeappmaker.com/">Jeba Blogs™</a>. All
            Rights Reserved.
          </span>
